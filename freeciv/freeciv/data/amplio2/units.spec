...
artists = "
    ...
    qwm                 [QWM]
    Tanelorn            [T]
    *                   [*m] = was used as inspiration/model in creating an original work
"
...
tiles = { "row", "column", "tag"
  ...
  0,  1, "u.howitzer"		      ; [Nemo] & [Lexxie]--fallback: u_howitzer_o is in units_oversize.spec
  0,  2, "u.battleship"	      ; [Lexxie]
  0,  3, "u.bomber"		        ; [GB]
  0,  4, "u.cannon"		        ; [Lexxie]
  0,  5, "u.caravan"		      ; [Lexxie]
  ...
  0, 15, "u.knights"		      ; [Lexxie] & [BB][*m]
  0, 16, "u.legion"		        ; [Lexxie] & [GB][*m]
  0, 17, "u.mech_inf"		      ; [GB] & [Lexxie]
  0, 18, "u.warriors"		      ; [Lexxie]
  0, 19, "u.musketeers"       ; [Lexxie]
  1,  0, "u.nuclear"		      ; [Nemo] & [CS] & [Lexxie]
  1,  1, "u.phalanx"		      ; [Lexxie]
  1,  2, "u.riflemen"		      ; [Lexxie] & [GB]
  1,  3, "u.caravel"		      ; [Lexxie]
  1,  4, "u.settlers"		      ; [Lexxie]
  1,  5, "u.submarine"	      ; [GP] & [Lexxie]
  1,  6, "u.transport"	      ; [Lexxie]
  1,  7, "u.trireme"		      ; [Lexxie]
  1,  8, "u.archers"		      ; [Lexxie] & [GB]
  1,  9, "u.cavalry"		      ; [Lexxie]
  1, 10, "u.cruise_missile"	  ; [Lexxie]
  1, 11, "u.destroyer"	  	  ; [Nemo] & [Lexxie]
  1, 12, "u.dragoons"		      ; [Lexxie] & [GB][*m]
  1, 13, "u.explorer"		      ; [Lexxie] & [Alex][CT][*m]
  1, 14, "u.freight"		      ; [CT] & [QWM] & [Lexxie] - This is the old Freight truck; see u.container for Freight container
  1, 15, "u.galleon"		      ; [BB] & [Lexxie]
  1, 16, "u.partisan"		      ; [Lexxie]
  1, 17, "u.pikemen"		      ; [T][*m] & [Lexxie]
  ...
  2,  8, "u.aegis_cruiser"	  ; [Lexxie]
  2,  9, "u.paratroopers"	    ; [Lexxie] & [Alex][*m]
  2, 10, "u.elephants"		    ; [Lexxie]
  2, 11, "u.crusaders"	  	  ; [BB] & [Lexxie]
  2, 12, "u.fanatics"		      ; [Lexxie] & [GB][*m]
  2, 13, "u.awacs"		        ; [Lexxie]
  2, 14, "u.worker"		        ; {Lexxie] & [GB][*m]
  2, 15, "u.leader"		        ; [GB]
  2, 16, "u.barbarian_leader"	; [FiftyNine] & [Lexxie]
  2, 17, "u.migrants"		      ; [Lexxie] & [Eleazar][*m]
  ...
  3,  5, "u.container"        ; [Lexxie]      ; the Freight unit graphic used in MP2C onward (not u.freight)
  3,  6, "u.atom_bomb"        ; [Lexxie]
  3,  7, "u.galley"           ; [Unknown] & [Lexxie]
  3,  8, "u.jet_fighter"      ; [Lexxie] & [Nemo][AHS][*m]
  3,  9, "u.ram_ship"         ; [Lexxie]
  3, 10, "u.armor_ii"         ; [Unknown] & [Lexxie]
  3, 11, "u.boat"             ; [Lexxie]
  ...
  3, 18, "u.queen"            ; [Lexxie] & [GB][*m]
  3, 19, "u.hbomb"            ; [Lexxie]
  4,  0, "u.tnuke"            ; [Lexxie]
  4,  1, "u.ddomb"            ; [Lexxie]  Doomsday Bomb, should've been u.ddbomb
  4,  2, "u.spy"              ; [Lexxie]
  4,  3, "u.train"            ; [Lexxie]
  ...
  4, 10, "u.zealots"          ; [Lexxie] & [GB]
  4, 11, "u.peasants"         ; [Lexxie] & [Unknown]
